package ru.jucharick.NoteRestApplication.aspect;
...
public class LoggingAspect {
    // @annotation
    @Around("@annotation(ru.jucharick.NoteRestApplication.aspect.TrackUserAction)")
    @Order(1)
    ...
    // execution
    @Around("execution(* ru.jucharick.NoteRestApplication.repository.*.*(..))")
    @Order(2)
